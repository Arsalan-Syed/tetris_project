...
def create_initial_population(size_of_initial_population,
                              coded_string_length,
                              range_of_genes_maximum):
    population = [(random.sample(range(1, range_of_genes_maximum),
                                 coded_string_length))
                  for _ in range(size_of_initial_population)]
    return population
...
def optimize_it():
    ...
    # are from 1 to 10
    individuals = create_initial_population(20, 5, 10)
